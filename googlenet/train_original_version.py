...
from original_model import MyGoogLeNet
...
def get_args():
    ...
    parser.add_argument("--checkpoint", type=str, default="original_version_checkpoint")
    parser.add_argument("--resume", type=bool, default=False)
    parser.add_argument("--logdir", type=str, default="original_version_tensorboard")
...
def train(args):
    ...
    model = MyGoogLeNet(len(train_data.categories)).to(device)
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for i, (images, labels) in enumerate(train_progressbar):
            ...
            outputs, auxiliar1, auxiliar2 = model(images)
            loss = criterion(outputs, labels)
            loss_auxiliar1 = criterion(auxiliar1, labels)
            loss_auxiliar2 = criterion(auxiliar2, labels)
            loss += 0.3 * (loss_auxiliar1 + loss_auxiliar2)
